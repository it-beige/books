<template>
  <div class="edit-table-box">
    <div class="top-tool-box">
      ...
      <div v-if="controlBar.length>0" class="right-tool">
        <el-tooltip v-if="controlBar.includes('edit')" effect="dark" content="编辑" placement="bottom">
          <el-button type="success" icon="el-icon-edit" circle @click="handleControlBar('edit')" />
        </el-tooltip>
        <el-tooltip v-if="controlBar.includes('delete')" effect="dark" content="删除" placement="bottom">
          <el-button type="danger" icon="el-icon-delete" circle @click="handleControlBar('delete')" />
        </el-tooltip>
        <el-tooltip v-if="controlBar.includes('refresh')" effect="dark" content="刷新" placement="bottom">
          <el-button icon="el-icon-refresh" circle @click="$emit('refresh')" />
        </el-tooltip>
        <el-tooltip v-if="controlBar.includes('column')" effect="dark" content="选择显示列" placement="bottom">
          <el-button icon="el-icon-menu" circle @click="tableColumnVisible = true" />
        </el-tooltip>
        <el-tooltip v-if="controlBar.includes('search')" effect="dark" content="隐藏搜索框" placement="bottom">
          <el-button icon="el-icon-search" circle @click="$emit('search')" />
        </el-tooltip>
      </div>
    </div>
    <el-table
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <slot name="toolbar" :data="{scope}" />
        </template>
      </el-table-column>
      <no-data slot="empty" />
    </el-table>
    <el-scrollbar :native="true">
      <div v-if="pageInfo.total && data.length" class="page-box">
        <el-pagination
    ...
    <el-dialog title="表格列" :visible.sync="tableColumnVisible">
      <el-transfer v-model="showColumn" :data="transData" :titles="['隐藏列','显示列']" />
    </el-dialog>
  </div>
</template>
